...
angular
    ...
    .service( '$fileUploader', [ '$compile', '$rootScope', function( $compile, $rootScope ) {
        ...
        Uploader.prototype = {
             ...
             * @returns {Number}
             */
            getIndexOfItem: function( item ) { return this.queue.indexOf( item ); },
            /**
            ...
            link: !window.File ? angular.noop : function( $scope, $element ) {
                $element
                    .bind( 'drop', function( event ) {
                        var dataTransfer = event && event.dataTransfer ? event.dataTransfer : event.originalEvent.dataTransfer; // jQuery fix;
